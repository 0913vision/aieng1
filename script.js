...
//   "시작!\n왼쪽을 눌러 이전\n오른쪽을 눌러 다음",
//   "질량 보존의 법칙이란?",
//   "화학반응에서 질량은 창조되거나 소멸되지 않는다.",
//   "일정 성분비의 법칙(definite)이란?",
//   "주어진 화합물에서 질량비는 항상 정확히 같다.",
//   "배수 비례의 법칙(multiple)이란?",
//   "두 원소가 서로 다른 일련의 화합물을 형성할 때, 한 원소와 반응하는 다른 원소의 질량비는 간단한 정수로 나타낼 수 있다.",
//   "전이금속을 영어로?",
//   "Transition metals",
//   "알칼리금속과 알칼리 토금속을 영어로?",
...
//   "NH4NO3는 무엇인가?",
//   "Ammonium Nitrate",
//   "chromium(VI) oxide는 무엇인가?",
//   "CrO3",
//   "disulfur dichloride는 무엇인가?",
//   "S2Cl2",
//   "Nickle(II) fluoride는 무엇인가?",
//   "NiF2",
//   "potassouim hydrogen phosphate는 무엇인가?",
//   "K2HPO4",
//   "Aluminum nitride는 무엇인가?",
//   "AlN",
//   "Ammonia는 무엇인가?",
//   "NH3",
//   "manganese(IV) sulfide는 무엇인가?",
//   "MnS2",
//   "sodium dichromate는 무엇인가?",
//   "Na2Cr2O7",
//   "Ammonium sulfite는 무엇인가?",
//   "(NH4)2SO3",
//   "carbon tetraiodide는 무엇인가?",
//   "CI4",
//   "K+",
//   "Potassium (포타슘)",
//   "Cs+",
...
//   "Lead(II), Lead(IV) (납)",
//   "Hg의 가능한 상태는?",
//   "Mercury(I), Mercury(II) (수은, 이온기호 반드시확인)",
//   "Ag+란?",
//   "Silver (은)",
//   "Zn2+란?",
//   "Zinc (아연)",
...
//   "Sulfate의 이온기호는?",
//   "(SO4)2-",
//   "Hydrogen sulfate, 또는 bisulfate의 이온기호는?",
//   "(HSO4)-",
//   "Hydroxide의 이온기호는?",
//   "(OH)-",
//   "Cyanide의 이온기호는?",
...
//   "Phosphate의 이온기호는?",
//   "(PO4)3-",
//   "Hydrogen phosphate의 이온기호는?",
//   "(HPO4)2-",
//   "Dihydrogen phosphate의 이온기호는?",
//   "(H2PO4)-",
//   "Thiocyanate의 이온기호는?",
//   "(NCS)- 또는 (SCN)-",
//   "Carbonate의 이온기호는?",
//   "(CO3)2-",
//   "Hydrogen carbonate, 또는 bicarbonate의 이온기호는?",
//   "(HCO3)-",
//   "Hypochlorite의 이온기호는?",
//   "(ClO)- 또는 (OCl)-",
//   "Chlorite의 이온기호는?",
...
let flashcardContents = [
  ...
  "informative","유익한",
  "impressive","인상깊은",
  "considerable increase","상당한 증가",
  "be considerate of","~을 배려하다\n(고려한다는 건 배려한다는 것)",
  "reliable service","신뢰할 만한 서비스",
  "be reliant on","~에 의지하다",
  "be responsive to","~에 반응하다",
  "be respontible for","~을 책임지다, ~에 책임이 있다",
  "late","늦게",
  "lately","최근에",
  "hard","열심히",
  "hardly","거의~않는",
  ...
  "be aware of","~을 알다",
  "be available for","~이 이용 가능하다",
  "be (un)able to+V","~할 수 있다(없다)",
  "be eligible for+N/to+V","~할 자격이 있다",
  "끝\n오른쪽을 눌러 재시작"
];
